...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Uso robusto de BASE_URL para soportar despliegue en subcarpetas (GitHub Pages)
    // import.meta.env.BASE_URL contendrá '/ppt-nestle/' en producción
    const baseUrl = import.meta.env.BASE_URL.endsWith('/') 
      ? import.meta.env.BASE_URL 
      : `${import.meta.env.BASE_URL}/`;
      
    fetch(`${baseUrl}content/content.json`)
      .then(res => {
